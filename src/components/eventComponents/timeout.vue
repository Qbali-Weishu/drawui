<template>
	<div 
	        draggable="false"
	        style="margin-top: 20px;min-width: 330px;height:165px;background-color: white;border-radius: 15px;padding: 10px;box-sizing: border-box;position: absolute;transition: .2s;" 
	        ref="forOut"
			:id="xpathId"
	        ...
	        >
	                <div class="header" draggable="false">
						<div class="logicName" >
	                        ...
	                        <!--头部参数列表-->
							<h3 style="margin: 0;padding: 0;font-weight: normal;margin-top: 10px;margin-left: 10px;line-height: 30px;">延时时间</h3>
							<div class="inputDiv" style="display: flex;box-sizing: border-box;overflow: hidden;width: 30%;">
							...
							<h3 style="margin: 0;padding: 0;margin-top: 10px;margin-left: 10px;font-weight: normal;width: 40px;height: 35px;line-height: 35px;background-color: transparent;color: var(--mainColorGray2);user-select: none;">毫秒</h3>
...
<script>
	...
	export default{
		...
		mounted(){
			...
			System.pushComDesc(this.getEcId(),"/*延时"+this.timeoutValue+"毫秒执行*/")
		},
		methods:{
